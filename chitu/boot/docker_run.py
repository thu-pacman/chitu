...
def docker_run(cfg, raw_argv, master_addr, master_port, rdvz_port, rdvz_id):
    ...
    docker_cmd += torchrun_args
    docker_cmd += target_args
    if cfg.boot.relay_args:
        docker_cmd += raw_argv[1:]
