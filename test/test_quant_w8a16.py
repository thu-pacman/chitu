...
parser.add_argument("--model_path", type=str, default="/home/ss/models/Qwen2-7B-Instruct",  help="Model path")
parser.add_argument("--quant_file", type=str,  default = "/home/cyd/models/Qwen2-7B-Instruct-w8a16", help="quant_file Model path")
