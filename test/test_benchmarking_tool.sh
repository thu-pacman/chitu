...
grun torchrun --nproc_per_node 1 --master_port=22528 -m chitu models=Qwen2-7B-Instruct models.ckpt_dir=/home/share/models/Qwen2-7B-Instruct serve.host=127.0.0.1 serve.port=21100 &
sleep 10s
