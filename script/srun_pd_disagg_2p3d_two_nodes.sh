     ...
     bash -c "
        ...
        if [ \"\$SLURM_PROCID\" = \"0\" ]; then
            ...
            CUDA_VISIBLE_DEVICES=0 \$RUNNER_CMD torchrun --nproc_per_node=1 --master_port=29501 -m chitu \
                ...
                scheduler.type=\"decode_only\" infer.use_cuda_graph=True infer.has_schedule_overlap=False > \"$LOG_DIR/decode1.log\" 2>&1 &
            D1_PID=\$!
            CUDA_VISIBLE_DEVICES=1 \$RUNNER_CMD torchrun --nproc_per_node=1 --master_port=29502 -m chitu \
                ...
                scheduler.type=\"decode_only\" infer.use_cuda_graph=True infer.has_schedule_overlap=False > \"$LOG_DIR/decode2.log\" 2>&1 &
            D2_PID=\$!
            CUDA_VISIBLE_DEVICES=2 \$RUNNER_CMD torchrun --nproc_per_node=1 --master_port=29503 -m chitu \
                ...
                scheduler.type=\"decode_only\" infer.use_cuda_graph=True infer.has_schedule_overlap=False > \"$LOG_DIR/decode3.log\" 2>&1 &
            D3_PID=\$!
            ...
            CUDA_VISIBLE_DEVICES=0,1 \$RUNNER_CMD torchrun --nproc_per_node=2 --master_port=29510 -m chitu \
                ...
                scheduler.type=\"prefill_only\" infer.use_cuda_graph=True infer.has_schedule_overlap=False > \"$LOG_DIR/prefill1.log\" 2>&1 &
            P1_PID=\$!
            CUDA_VISIBLE_DEVICES=2,3 \$RUNNER_CMD torchrun --nproc_per_node=2 --master_port=29511 -m chitu \
                ...
                scheduler.type=\"prefill_only\" infer.use_cuda_graph=True infer.has_schedule_overlap=False > \"$LOG_DIR/prefill2.log\" 2>&1 &
            P2_PID=\$!
