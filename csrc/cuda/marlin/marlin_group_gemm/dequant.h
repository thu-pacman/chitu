...
dequant<nv_bfloat162, vllm::kU4B8.id(), true>(int q, nv_bfloat162 *frag_b) {
...
template <>
__device__ inline void
dequant<nv_bfloat162, vllm::kU4B8.id(), false>(int q, nv_bfloat162 *frag_b) {
    dequant<nv_bfloat162, vllm::kU4B8.id(), true>(q, frag_b);

    static constexpr uint32_t SUB = 0x43084308;

    frag_b[0] =
        __hsub2(frag_b[0], *reinterpret_cast<const nv_bfloat162 *>(&SUB));
    frag_b[1] =
        __hsub2(frag_b[1], *reinterpret_cast<const nv_bfloat162 *>(&SUB));
}

template <>
__device__ inline void
dequant<nv_bfloat162, vllm::kU4.id(), true>(int q, nv_bfloat162 *frag_b) {
    dequant<nv_bfloat162, vllm::kU4B8.id(), true>(q, frag_b);
}

template <>
__device__ inline void
dequant<nv_bfloat162, vllm::kU4.id(), false>(int q, nv_bfloat162 *frag_b) {
...
template <>
__device__ inline void
dequant<half2, vllm::kU8B128.id(), false>(int q, half2 *frag_b) {
    dequant<half2, vllm::kU8B128.id(), true>(q, frag_b);

    static constexpr uint32_t I8s_TO_F16s_MAGIC_NUM = 0x64806480;
    frag_b[0] = __hsub2(
        frag_b[0], *reinterpret_cast<const half2 *>(&I8s_TO_F16s_MAGIC_NUM));
    frag_b[1] = __hsub2(
        frag_b[1], *reinterpret_cast<const half2 *>(&I8s_TO_F16s_MAGIC_NUM));
}
...
template <>
__device__ inline void
dequant<nv_bfloat162, vllm::kU8B128.id(), false>(int q, nv_bfloat162 *frag_b) {
...
template <>
__device__ inline void
dequant<nv_bfloat162, vllm::kU8.id(), false>(int q, nv_bfloat162 *frag_b) {
    float fp32_intermediates[4];
    uint32_t *fp32_intermediates_casted =
        reinterpret_cast<uint32_t *>(fp32_intermediates);
...
template <>
__device__ inline void
dequant<half2, vllm::kFE4M3fn.id(), true>(int q, half2 *frag_b) {
...
template <>
__device__ inline void
dequant<half2, vllm::kFE4M3fn.id(), false>(int q, half2 *frag_b) {
...
template <>
__device__ inline void
dequant<nv_bfloat162, vllm::kFE4M3fn.id(), true>(int q, nv_bfloat162 *frag_b) {
...
template <>
__device__ inline void
dequant<nv_bfloat162, vllm::kFE4M3fn.id(), false>(int q, nv_bfloat162 *frag_b) {
...
template <>
__device__ inline void
dequant<half2, vllm::kFE2M1f.id(), false>(int q, half2 *frag_b) {
...
template <>
__device__ inline void
dequant<nv_bfloat162, vllm::kFE2M1f.id(), true>(int q, nv_bfloat162 *frag_b) {
    // Constants for FP4 (E2M1) and FP16 formats
...
template <>
__device__ inline void
dequant<nv_bfloat162, vllm::kFE2M1f.id(), false>(int q, nv_bfloat162 *frag_b) {
...
template <>
__device__ inline void
dequant_fp8_scales<half2, vllm::kFE4M3fn.id()>(int q, half2 *frag_b) {
...
template <>
__device__ inline void
dequant_fp8_scales<nv_bfloat162, vllm::kFE4M3fn.id()>(int q,
                                                      nv_bfloat162 *frag_b) {
    constexpr int FP8_EXPONENT = 4, BF16_EXPONENT = 8;
    constexpr int RIGHT_SHIFT = BF16_EXPONENT - FP8_EXPONENT;
    constexpr int MASK = 0x7F007F00;
...
template <>
__device__ inline void
dequant_fp8_scales<nv_bfloat162, vllm::kFE8M0fnu.id()>(int q,
                                                       nv_bfloat162 *frag_b) {
